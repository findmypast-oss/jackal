...
test('validateConsumer', t => {
  ...
  const notOk = { valid: false, error: { name: 'ValidationError', message: '!"£&*^()*£" is invalid, \'consumer\' should be in format \'<consumer>\' where [a-zA-Z0-9_] are valid parameter characters' } }
