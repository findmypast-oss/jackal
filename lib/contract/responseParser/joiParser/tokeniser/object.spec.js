...
test('tokenise - object with single key', t => {
  t.plan(1)
...
test('tokenise - object with single key using keys object', t => {
  t.plan(1)
...
test('tokenise - object with multiple keys', t => {
  t.plan(1)
...
test('tokenise - object with multiple keys using keys object', t => {
  t.plan(1)
