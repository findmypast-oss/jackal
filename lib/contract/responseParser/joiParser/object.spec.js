...
test('parseJoi - object with single key', t => {
  t.plan(2)
...
test('parseJoi - object with single key using keys function', t => {
  t.plan(2)
...
test('parseJoi - object with multiple keys', t => {
  t.plan(3)
...
test('parseJoi - object with multiple keys using keys function', t => {
  t.plan(3)
