...
test('parseJoi - boolean statement', function (t) {
  t.plan(6)
...
test('parseJoi - date statement', function (t) {
  t.plan(19)
...
test('parseJoi - date_iso statement', function (t) {
  t.plan(19)
...
test('parseJoi - integer statement', function (t) {
  t.plan(6)
...
test('parseJoi - number statement', function (t) {
  t.plan(6)
...
test('parseJoi - string statement', function (t) {
  t.plan(4)
...
test('parseJoi - string_email statement', function (t) {
  t.plan(5)
...
test('parseJoi - string_guid statement', function (t) {
  t.plan(5)
...
test('parseJoi - optional statement', function (t) {
  t.plan(4)
...
test('parseJoi - required statement', function (t) {
  t.plan(4)
...
test('parseJoi - statement with single allow clause', function (t) {
  t.plan(6)
...
test('parseJoi - statement with multiple allow clauses', function (t) {
  t.plan(11)
...
test('parseJoi - statement with allow clause with multiple values', function (t) {
  t.plan(11)
