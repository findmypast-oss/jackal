...
test('parseResponse - number statement', t => {
  t.plan(7)
...
test('parseResponse - statement with multiple allows in multiple calls', t => {
  t.plan(10)
...
test('parseResponse - statement with multiple allows in a single array', t => {
  t.plan(10)
