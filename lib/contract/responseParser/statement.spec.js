...
test('parseResponse - boolean statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"boolean"' })
...
test('parseResponse - date statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"date"' })
...
test('parseResponse - date_iso statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"date_iso"' })
...
test('parseResponse - integer statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"integer"' })
...
test('parseResponse - real statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"real"' })
...
test('parseResponse - string statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"string"' })
...
test('parseResponse - string_email statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"string_email"' })
...
test('parseResponse - string_guid statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"string_guid"' })
...
test('parseResponse - boolean statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: '"boolean(NULL)"' })
...
test('parseResponse - boolean statement', t => {
  ...
  const schema = parseResponse({ statusCode: 200, body: `"boolean(NULL,'string',1,-1,2.3,-2.3)"` })
